...
class TestDiffusionSamplingInferer(unittest.TestCase):
    ...
    def test_prediction_shape(self, ae_model_type, autoencoder_params, dm_model_type,
                              stage_2_params, input_shape, latent_shape):
    ...
    @parameterized.expand(TEST_CASES)
    def test_sample_intermediates(self, ae_model_type, autoencoder_params, dm_model_type, stage_2_params,
    ...
    @parameterized.expand(TEST_CASES)
    def test_get_likelihoods(self, ae_model_type, autoencoder_params, dm_model_type, stage_2_params,
                             input_shape, latent_shape):
        if ae_model_type == "AutoencoderKL":
            stage_1 = AutoencoderKL(**autoencoder_params)
        if ae_model_type == "VQVAE":
    ...
    @parameterized.expand(TEST_CASES)
    def test_resample_likelihoods(self, ae_model_type, autoencoder_params, dm_model_type,
                                  stage_2_params, input_shape, latent_shape):
        if ae_model_type == "AutoencoderKL":
            stage_1 = AutoencoderKL(**autoencoder_params)
        if ae_model_type == "VQVAE":
