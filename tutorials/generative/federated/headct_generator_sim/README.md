## 2D Head CT generator - Simulation
In the following, we show an example of running MONAI-bundle configurations with a generative model and NVFlare using
the [FL simulator](https://nvflare.readthedocs.io/en/main/user_guide/fl_simulator.html).
